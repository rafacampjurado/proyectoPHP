...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2018 a las 18:31:27
...
INSERT INTO `opiniones` (`idOpinion`, `idUsuario`, `idProducto`, `Opinion`) VALUES
(1, 3, 1, 'Muy buenos tomates');
...
--
ALTER TABLE `opiniones`
  MODIFY `idOpinion` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
